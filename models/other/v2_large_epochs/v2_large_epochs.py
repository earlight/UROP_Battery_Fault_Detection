...
# df = df.sample(frac=0.1, random_state=99).reset_index(drop=True) # TODO: small sample for testing
...
def model_train(model, X_train, y_train, X_val, y_val):
    ...
    n_epochs = 512   # number of epochs to run
...
model_path = './models/v2_large_epochs/results/' + model_timestamp + '_brand' + str(brand) + '.pth'
...
plt.savefig('./models/v2_large_epochs/results/' + model_timestamp + '_brand' + str(brand) + '.png')