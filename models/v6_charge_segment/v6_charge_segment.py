...
model_path = './models/v6_charge_segment/results/' + model_timestamp + '_brand' + str(brand) + '.pth'
...
plt.savefig('./models/v6_charge_segment/results/' + model_timestamp + '_brand' + str(brand) + '.png')
...
test_data.to_csv('./models/v6_charge_segment/results/' + model_timestamp + '_brand' + str(brand) + '.csv', index=False)