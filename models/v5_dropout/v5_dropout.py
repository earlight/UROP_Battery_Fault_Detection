...
model_path = './models/v5_dropout/results/' + model_timestamp + '_brand' + str(brand) + '.pth'
...
plt.savefig('./models/v5_dropout/results/' + model_timestamp + '_brand' + str(brand) + '.png')
...
test_data.to_csv('./models/v5_dropout/results/' + model_timestamp + '_brand' + str(brand) + '.csv', index=False)